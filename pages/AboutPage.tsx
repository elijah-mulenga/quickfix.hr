...
import albertMandoImg from "@/assets/albert-mando.jpg";
import henryMilanziImg from "@/assets/henry-milanzi.jpg";
import clarissyMwapeImg from "@/assets/clarissy-mwape.jpg";
import wiganMumbaImg from "@/assets/wigan-mumba.jpg";
            ...
            {team.map((member, i) => (
              <FadeInSection key={i} delay={i * 0.1}>
                <div className="bg-card border border-border rounded-lg overflow-hidden card-lift">
                  ...
                  <div className="p-6">
                    {member.photo ? (
                      <img src={member.photo} alt={member.name} className="w-16 h-16 rounded-full object-cover border-2 border-primary mb-4" />
                    ) : (
